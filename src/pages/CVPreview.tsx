...
export function CVPreview({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-100 flex flex-col">
      ...
      {/* CV Preview Area - Center on all screens */}
      ...
      {/* Payment Modal - Responsive Bottom Sheet on Mobile */}
      {showPayment && (
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Copy size={14} className="text-zinc-300 cursor-pointer active:text-blue-500" onClick={() => navigator.clipboard.writeText('91691764')}/>
                  </div>
                </div>
                <div className="flex justify-between items-center">
      ...
      {/* Themes Modal - Responsive Bottom Sheet */}
      {showThemes && (
        <div className="fixed inset-0 bg-zinc-900/60 z-50 flex items-end sm:items-center justify-center backdrop-blur-sm animate-in fade-in duration-300">
