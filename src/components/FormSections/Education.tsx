        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full px-4 py-3 bg-gray-50 border-none rounded-2xl text-sm outline-none focus:ring-2 focus:ring-blue-500 transition-all shadow-inner appearance-none cursor-pointer"
            >
